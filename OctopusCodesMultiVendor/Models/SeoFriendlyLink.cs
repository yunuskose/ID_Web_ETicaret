...
namespace IDETicaret.Models
{
    public static class SeoFriendlyLink
    {
        ...
        public static string SeoLinkSolMenu1(this UrlHelper urlHelper, string categori1,  string isim, string page)
        {
            string title = isim.ToLower();
            title = FriendlyURLTitle(title);
            return string.Format("/Product/Category/{0}/{1}/{2}", categori1, title, page);
        }
        public static string SeoLinkSolMenu2(this UrlHelper urlHelper, string categori1, string categori2, string isim, string page)
        {
            string title = isim.ToLower();
            title = FriendlyURLTitle(title);
            return string.Format("/Product/Category2/{0}/{1}/{2}/page", categori1, categori2, title, page);
        }

        public static string SeoLinkSolMenu3(this UrlHelper urlHelper, string categori1, string categori2, string categori3, string isim, string page)
        {
            string title = isim.ToLower();
            title = FriendlyURLTitle(title);
            return string.Format("/Product/Category3/{0}/{1}/{2}/{3}/{4}", categori1, categori2, categori3, title, page);
        }
        public static string SeoLinkSolMenu4(this UrlHelper urlHelper, string categori1, string categori2, string categori3, string categori4, string isim, string page)
        {
            string title = isim.ToLower();
            title = FriendlyURLTitle(title);
            return string.Format("/Product/Category4/{0}/{1}/{2}/{3}/{4}/{5}", categori1, categori2, categori3, categori4, title, page);
        }
